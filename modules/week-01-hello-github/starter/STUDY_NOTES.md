...
Answer: Figuring out the setup and command line without the videos

**How you solved it:**
[Explain what you did to overcome the challenge - search online, ask for help, restart your computer, etc.]

Answer: kind of just brute forcing it and looking up what things do until remembering there are videos

**Most confusing concept:**
[What was hardest to understand? Git commands, terminal navigation, C# syntax, or dotnet CLI?]

Answer: everything in the command terminal was new to me
...
Answer: git add is like adding to the list of changes, commit saves the changes and push uploads it

**Why do we create branches?**
[Explain the purpose of creating a student branch]

Answer: to be able to make changes without ruining the main
...
Answer:if you dont know how to use programs to program you cant program
...
Answer:the whole thing, i kept learning a tiny bit then putting it off for other things and then forgetting
